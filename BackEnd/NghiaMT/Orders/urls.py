...
urlpatterns = [
    ...
    #          views.CategoryDelete, name='CategoryDelete'),
     ...
     path('create-order/', views.OrderCreate,
         name='create-order'),   
     path('payment-momo/', views.paymentWithMomo,
         name='payment-momo'),
     path('list-all/', views.GetListOrder,
         name='GetListOrder'),     
     path('list-by-user/<str:userid>/', views.GetListOrderByUser,
     ...
     path('cancel-order/<str:id>/', views.CancelOrder,
         name='CancelOrder'),  
     path('delete-order/<str:id>/', views.DeleteOrder,
         name='DeleteOrder'),  
     path('success-order/<str:id>/', views.SuccessPaymentOrder,
         name='SuccessPaymentOrder'), 
